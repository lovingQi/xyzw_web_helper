 ...
 */
const matchesCronExpression = (cronExpression, now = new Date()) => {
...
module.exports = { validateCronField, validateCronExpression, parseCronField, calculateNextRuns, calculateNextExecutionTime, formatTimeDifference, matchesCronExpression };
